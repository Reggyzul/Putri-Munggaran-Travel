        ...
        <div className="bg-gradient-to-r from-[#0f2b5c] via-[#1e3a8a] to-[#0b1736] rounded-3xl p-8 border border-blue-800/60 shadow-2xl mb-14 grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          <div className="md:col-span-8 text-left space-y-2">
            ...
            <p className="font-sans text-xs text-slate-300 font-medium max-w-xl leading-relaxed">
              Dapatkan penawaran sewa kendaraan & paket wisata terjangkau dengan armada terawat dan pelayanan prima.
            </p>
          </div>
          <div className="md:col-span-4 flex justify-start md:justify-end">
            ...
            >
              ...
              <span>WhatsApp: 08562042336</span>
            </a>
          </div>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="font-sans text-[10px] font-bold text-red-400 tracking-wider block mt-0.5">
                  SOLUSI TRANSPORTASI & WISATA TERPERCAYA
                </span>
              </div>
            </div>

            <p className="font-sans text-xs text-slate-400 leading-relaxed max-w-md font-medium">
              Penyedia layanan transportasi dan perjalanan wisata melayani kebutuhan individu, keluarga, perusahaan, hingga instansi dengan armada terawat, pengemudi profesional, dan pelayanan mengutamakan kenyamanan.
            </p>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="space-y-3 text-xs text-slate-300 font-medium">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="font-bold text-white block">Alamat Kantor Resmi:</span>
                  <span className="text-slate-400 leading-relaxed block">
                    Jl. Yudo No. 7, Arcamanik Endah, Bandung, Jawa Barat
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <span className="font-bold text-white block">WhatsApp Respon Cepat:</span>
                  <a
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <span className="font-bold text-white block">Jam Operasional Layanan:</span>
                  <span className="text-slate-400 block">Senin - Minggu: 24 Jam Non-Stop</span>
                </div>
              </div>
            </div>
          </div>
